...
const CustomFeed=  () => {
	...
	async function showFeed() {
		...
		{
			requestOptions.body=JSON.stringify({lastpost_user_id:lastpost_user_id_,lastpost_post_id:lastpost_post_id_})
	...
	return (
		<IonContent>
			<p>Feed based location set by you</p>
			{posts}
			<button class="myButton" ref={feedButtonRef} onClick={() => showFeed()}>{feedButtonMessage}</button>
			<br/>
			<Link to="public">
